---
name: remote-testbed-logs
description: Locate and investigate historical firmware logs directly on a remote Pure testbed. Use for questions about a drive serial, bay/slot, prior installation, firmware event, or log time window on FlashArray, FlashBlade, or Endurance testbeds. Classifies the platform before searching, uses bounded archive discovery, and distinguishes controller logs from Jenkins artifacts.
---
